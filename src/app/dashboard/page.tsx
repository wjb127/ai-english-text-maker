      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">AI 맞춤형 영어 독해 학습을 시작해보세요</p>
            </div>
            {testResult && (
          ...
          {testResult && (
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">📊 최근 테스트 결과</h3>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{testResult.overallScore}점</div>
                  <div className="text-sm text-gray-600">종합 점수</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{testResult.totalCorrect}</div>
                  <div className="text-sm text-gray-600">정답 개수</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">{testResult.passageResults?.length || 0}</div>
                  <div className="text-sm text-gray-600">완료한 지문</div>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">맞춤형 독해 지문</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">학습 진도 분석</h3>
            <p className="text-gray-600 text-sm mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">AI 튜터링</h3>
            <p className="text-gray-600 text-sm mb-4">
        ...
        {subscriptionStatus === 'free' && (
          <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl shadow-xl p-8 text-white mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-2xl font-bold mb-2">🎁 무료 체험으로 업그레이드하세요!</h3>
              ...
              <div className="text-right">
                <Link
                  href="/subscription"
                  className="bg-white text-orange-600 px-6 py-3 rounded-xl font-bold hover:bg-gray-100 transition-all duration-200 inline-block"
                >
                  무료 체험 시작
                </Link>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h3 className="text-xl font-bold text-gray-900 mb-6">📈 학습 현황</h3>
          ...
          {testResult ? (
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">레벨 테스트 완료</div>
                    <div className="text-sm text-gray-600">5개 지문, {testResult.totalQuestions}문제 완료</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-bold text-blue-600">{testResult.overallScore}점</div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h4 className="font-semibold text-gray-900 mb-4">난이도별 성과</h4>
                  ...
                  {[1, 2, 3, 4, 5].map((level) => {
                    ...
                    return (
                      <div key={level} className="text-center">
                        ...
                        {passageResult ? (
                          <>
                            <div className={`text-2xl font-bold ${passageResult.score >= 70 ? 'text-green-600' : passageResult.score >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
                              {passageResult.score}점
                            </div>
                          ...
                          <div className="text-gray-400">미완료</div>
                        )}
                      </div>
                    )
                  })}
            ...
            <div className="text-center py-12">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">학습을 시작해보세요!</h4>
