  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-gray-900">AI 영어 독해</span>
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
                  ...
                  <div className="mt-4 p-4 bg-white rounded-lg border-l-4 border-blue-500">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center">
                        <div className="w-4 h-4 border-2 border-blue-500 bg-blue-500 rounded-full mr-2 flex items-center justify-center">
        ...
        <div className="text-center">
          <div className="bg-gray-900 rounded-2xl p-6 mb-8 max-w-md mx-auto">
            ...
            >
              <span className="font-medium">AI 독해 테스트 지금 시작하기</span>
      ...
      <div className="fixed right-6 bottom-6 space-y-3">
        ...
        >
          <span className="text-xs font-bold">무료<br />체험</span>
        </Link>
